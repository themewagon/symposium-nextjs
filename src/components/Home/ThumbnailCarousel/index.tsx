        ...
        <>
            <div>
                <Slider {...settingsFor} ref={mainSliderRef} className="pb-3">
                    <div>
                        <Image
                            src="/symposium-nextjs/images/ThumbnailSlider/Slider_1.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/symposium-nextjs/images/ThumbnailSlider/Slider_2.jpg"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/symposium-nextjs/images/ThumbnailSlider/Slider_3.png"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
                    ...
                    <div>
                        <Image
                            src="/symposium-nextjs/images/ThumbnailSlider/Slider_4.jpg"
                            alt="Conference"
                            width={0}
                            height={0}
                            quality={100}
